...
//        );
    ...
    public Product replaceProduct(Long id, Product product) {
        ...
        FakeStoreProductDto response = restTemplate.execute("https://fakestoreapi.com/products/"+id, HttpMethod.PUT, requestCallback, responseExtractor,responseExtractor);
